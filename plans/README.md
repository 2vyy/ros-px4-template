...
| 072  | Challenge authoring kit: `gen_world.py` (spec YAML → world SDF + marker map, golden-locked to marker_field) + `docs/CHALLENGES.md` rules-doc-to-verified-scenario playbook | P1 | M | 066 | DONE (2026-07-17, branch `advisor/072-challenge-authoring-kit`; golden marker_field round-trip; `gate_run` READY + topics clean; `just check`: 492 passed) |
